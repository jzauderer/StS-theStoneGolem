...
import theStoneGiant.patches.relics.BottledPlaceholderField;
import theStoneGiant.util.TextureLoader;

import java.util.Iterator;
import java.util.function.Predicate;

import static theStoneGiant.DefaultMod.makeRelicOutlinePath;
import static theStoneGiant.DefaultMod.makeRelicPath;
