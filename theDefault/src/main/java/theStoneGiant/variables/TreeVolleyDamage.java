package theStoneGiant.variables;
...
public class TreeVolleyDamage extends DynamicVariable
{   // Custom Dynamic Variables are what you do if you need your card text to display a cool, changing number that the base game doesn't provide.
    ...
    public String key()
    {
        return makeID("TREE_VOLLEY_DAMAGE");
    }
    ...
    public int value(AbstractCard card)
    {
        ...
        if(AbstractDungeon.player.hasPower(TreePower.POWER_ID)){
            trees = AbstractDungeon.player.getPower(TreePower.POWER_ID).amount;
        }
        return card.damage * trees;
    }
