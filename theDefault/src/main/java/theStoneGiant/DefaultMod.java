...
import theStoneGiant.cards.*;
import theStoneGiant.characters.TheDefault;
import theStoneGiant.events.IdentityCrisisEvent;
import theStoneGiant.potions.PlaceholderPotion;
import theStoneGiant.relics.BottledPlaceholderRelic;
import theStoneGiant.relics.DefaultClickableRelic;
import theStoneGiant.relics.PlaceholderRelic;
import theStoneGiant.relics.PlaceholderRelic2;
import theStoneGiant.util.IDCheckDontTouchPls;
...
public class DefaultMod implements
    ...
    // Character assets
    private static final String THE_DEFAULT_BUTTON = "theStoneGiantResources/images/charSelect/DefaultCharacterButton.png";
    private static final String THE_DEFAULT_PORTRAIT = "theStoneGiantResources/images/charSelect/DefaultCharacterPortraitBG.png";
    public static final String THE_DEFAULT_SHOULDER_1 = "theStoneGiantResources/images/char/defaultCharacter/shoulder.png";
    public static final String THE_DEFAULT_SHOULDER_2 = "theStoneGiantResources/images/char/defaultCharacter/shoulder2.png";
    public static final String THE_DEFAULT_CORPSE = "theStoneGiantResources/images/char/defaultCharacter/corpse.png";
    
    //Mod Badge - A small icon that appears in the mod settings menu next to your mod.
    public static final String BADGE_IMAGE = "theStoneGiantResources/images/Badge.png";
    
    // Atlas and JSON files for the Animations
    public static final String THE_DEFAULT_SKELETON_ATLAS = "theStoneGiantResources/images/char/defaultCharacter/skeleton.atlas";
    public static final String THE_DEFAULT_SKELETON_JSON = "theStoneGiantResources/images/char/defaultCharacter/skeleton.json";
    ...
    public DefaultMod() {
      ...
      */
        ...
        setModID("theStoneGiant");
        // cool
        // TODO: NOW READ THIS!!!!!!!!!!!!!!!:
        
        // 1. Go to your resources folder in the project panel, and refactor> rename theStoneGiantResources to
        // yourModIDResources.
    ...
    public void receiveEditCharacters() {
        ...
        BaseMod.addCharacter(new TheDefault("the Stone Giant", TheDefault.Enums.THE_DEFAULT),
...
//        BaseMod.addRelicToCustomPool(new DefaultClickableRelic(), TheDefault.Enums.COLOR_TINY);
    ...
    public void receiveEditCards() {
        ...
        new AutoAdd("TinyMod") // ${project.artifactId}
